...
@section('content')
    <div class="app" id="app">
        ...
        @elseif (Request::is ('dashboard/histories'))
            <userpanel-history-component :auth_user_id="{{Auth::user()->id}}"></userpanel-history-component>
        @elseif (Request::path() == 'dashboard/categories')
            <userpanel-category-component :auth_user_id="{{Auth::user()->id}}"></userpanel-category-component>
