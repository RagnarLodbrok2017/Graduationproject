                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-top: 25px; line-height: 0px">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-top: 15px; line-height: 0px"><img
...
<script src="{{asset('libraries/AdminDashboardLibs/libs/DataTables/datatables.min.js')}}"></script>
<script src="{{asset('libraries/AdminDashboardLibs/libs/datatable/datatable-advanced.init.js')}}"></script>
